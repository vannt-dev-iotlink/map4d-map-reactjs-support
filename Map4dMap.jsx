...
class Map4dMap extends React.Component {
  ...
  render() {    
    let url = `https://api-dev.map4d.vn/sdk/map/js?version=${this.props.version}&key=${this.props.accessKey}&callback=${this.callback}`  
    //let url = `http://localhost:6969/dist/2.4.4.js?callback=${this.callback}`  
    if (this.props.mapid) {
